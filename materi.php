...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">PYTHON</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item" href="login1.php" data-toggle="modal" data-target="#logoutModal">Logout</a>
        </div>
      </li>
    </ul>
  ...
  <div id="wrapper">
   ...
   => Manfaat Python 
   <br>
   <p>Meskipun ada banyak sekali bahasa pemrograman di luar sana, akan tetapi saya merekomendasikan Anda untuk belajar Python. Tentu juga ada beberapa kelebihan yang perlu Anda ketahui. Jika dibandingkan dengan bahasa pemrograman lain, berikut kelebihan bahasa pemrograman Python:

<br>1. Python memiliki sintaksis yang sederhana dan lebih mirip dengan Bahasa Inggris.

<br>2.Python dapat berjalan di berbagai macam sistem operasi.

<br>3.Python berjalan di dalam sistem interpreter, artinya bahasa baris kode bahasa pemrograman ini akan segera dieksekusi setelah ditulis.

<br>4.Python dapat diperlakukan dengan cara prosedural, cara berorientasi objek atau cara fungsional.

<br>5.Python memiliki sintaks yang memungkinkan pengembang untuk menulis program dengan ringkas daripada bahasa pemrograman lain.
<br>

<p> =>Cara membuat Python
<br>
...
Sebagai contoh, di bawah ini adalah tiga tipe numerik variabel yang berbeda:<br>

x = 1    # inty = 2.8  # floatz = 1j   # complex<br>
...
<br>
x = “Budi”# Ataux = ’Budi’<br>
# “Budi” sama artinya dengan ‘Budi’.<br>
<br>
